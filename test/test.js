...
System.register("test-es6", [], function() {
  "use strict";
        ...
        return $traceurRuntime.createGeneratorInstance(function($ctx) {
          while (true)
            switch ($ctx.state) {
              case 0:
                $ctx.state = 2;
                return adapter.save('john', 'john@email.com', 'secret');
              case 2:
                user = $ctx.sent;
                $ctx.state = 4;
                break;
        ...
        return $traceurRuntime.createGeneratorInstance(function($ctx) {
          while (true)
            switch ($ctx.state) {
              case 0:
                $ctx.state = 2;
                return adapter.find('email', 'john@email.com');
              case 2:
                user = $ctx.sent;
                $ctx.state = 4;
                break;
        ...
        return $traceurRuntime.createGeneratorInstance(function($ctx) {
          while (true)
            switch ($ctx.state) {
              case 0:
                $ctx.state = 2;
                return adapter.find('signupToken', token);
              case 2:
                user = $ctx.sent;
                $ctx.state = 4;
                break;
